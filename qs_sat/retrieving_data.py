...
if __name__ == "__main__":
    ...
    sql2 = "SELECT sy.ticker, dl.price_date, dl.close_price, dl.adj_factor, dl.volume FROM daily_price AS dl INNER JOIN symbol as sy WHERE sy.ticker='601988' ORDER BY dl.price_date DESC;"
